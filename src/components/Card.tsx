            ...
            <SwiperSlide key={product.id} className="!w-full p-6">
              <div className="flex flex-col h-full w-full">
                ...
                >
                  ...
                  {/* Icons */}
                  <div className="absolute top-3 right-3 flex flex-col gap-2 opacity-100">
                  ...
                  />
                  {/* Only "Add to cart" button on mobile */}
                  <div className="absolute bottom-0 left-0 right-0 flex justify-center gap-4 py-3">
                    <button className="bg-black w-70 justify-center text-white px-4 py-2 flex items-center gap-2 rounded hover:bg-gray-800">
                      <BsCart /> Add to cart
                    </button>
                  </div>
                </div>
        ...
        {products.map((product, idx) => (
          <div key={product.id} className="flex flex-col h-full">
            ...
            >
              ...
              />
              {/* Both buttons on desktop */}
              <div className="absolute bottom-0 left-0 right-0 opacity-0 group-hover:opacity-100 transition-all duration-300 flex justify-center gap-4 py-3">
