...
const Blogmain = () => {
    return (
        <div className='w-full p-4 md:p-6'>
            ...
            <div className='md:p-6 gap-6 md:h-[90dvh]'>
                <Swiper
                    modules={[Navigation]}
                    slidesPerView={1}
                    spaceBetween={20}
                        ...
                        return (
                            <SwiperSlide key={index} className='bg-white  overflow-hidden'>
                                ...
                                <div className='py-6'>
                                    ...
                                    <button className="mt-2 px-8 py-3 rounded-sm text-black border-1 hover:bg-[#ba933e] cursor-pointer text-sm mt-6 transition-all duration-300 hover:text-white">
                                        Read More
                                    </button>
                                </div>
                            </SwiperSlide>
